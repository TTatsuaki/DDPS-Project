...
![Coverage of Israel and Palestine through May](Ttatsuaki.png)
...
# CONCLUSION
Throughout various approaches taken to tackle the research question, it was possible to find multiple interesting trends throuhgout the analysis. The decrease of the key words used for both pro-israel and pro-palestinian sides led us initially to interpret the effort of media outlets to be more neutral. The observation on word clouds also assured that there were changes happening to the content of the coverage, particularly how pro-palestinian opinion was increasingly under spotlight. 

Further analysis conducted by dividing the media outlets into left and right wing gave us further insight to why this has happened. Since the use of neutral words quickly diminished for one (left-wing media outlets) than the other (right-wing media), it strengthens the argument that public voice did have effect over the way the topic was covered, especially for the former side. The analysis on topic modelling was also completemntary, as it clearly exhibited. the different approahces those two sides took in terms of their coverage. As mentioned in the limitation section, further analysis on the content of those articles could support this argument even more, yet the research conducted so far did yield notable results to a certain extent. 

Overall, the change in the frames over the course of May was clearly observable through the series of analysis conduted. Tendency for more neutral coverage was also observed especially for right-wing outlets, yet furhter analysis of the actual content of the articles will confirm this even more, as well as explaining in which specific ways such transition has happened. 
...
Respers France, L., 2021. Bella Hadid joined pro-Palestinian protests. [online] CNN. Available at: <https://edition.cnn.com/2021/05/17/entertainment/bella-hadid-palestinian-protest-trnd/index.html> [Accessed 7 April 2022].

Sanders, B. 2021. Bernie Sanders: The U.S. Must Stop Being an Apologist for the Netanyahu Government. [online] Available at: 	<https://www-nytimes-com.acces-distant.sciencespo.fr/2021/05/14/opinion/bernie-sanders-israel-palestine-gaza.html> [Accessed 7 April 2022].

Savitsky, S., 2021. Bella Hadid accused of sharing anti-Semitic rhetoric over Israeli-Palestinian clash. [online] Fox News. Available at: 	<https://www.foxnews.com/entertainment/bella-hadid-anti-semitic-rhetoric> [Accessed 7 April 2022].
